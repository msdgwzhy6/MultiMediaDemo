...
import com.hyty.cordova.camera.listener.TypeListener;
import com.hyty.cordova.camera.state.CameraMachine;
...
//        });
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        Timber.d("JCameraView SurfaceCreated");
        new Thread() {
            @Override
            public void run() {
