...
import static com.hyty.cordova.camera.JCameraView.BUTTON_STATE_BOTH;
import static com.hyty.cordova.camera.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.hyty.cordova.camera.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    public CaptureButton(Context context, int size) {
        ...
        Timber.d( "CaptureButtom start");
        duration = 10 * 1000;              //默认最长录制时间为10s
        Timber.d( "CaptureButtom end");
