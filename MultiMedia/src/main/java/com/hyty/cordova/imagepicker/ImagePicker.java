package com.hyty.cordova.imagepicker;
...
import com.hyty.cordova.imagepicker.loader.ImageLoader;
import com.hyty.cordova.imagepicker.util.ProviderUtil;
import com.hyty.cordova.imagepicker.util.Utils;
import com.hyty.cordova.imagepicker.view.CropImageView;
...
public class ImagePicker {
    ...
    public void takePicture(Activity activity, int requestCode) {
        ...
        Intent takePictureIntent = new Intent(activity, TakeCameraActivity.class);
        takePictureIntent.putExtra(Key.REQUEST_CODE, requestCode);
        takePictureIntent.putExtra(Key.REQUEST_ALLREADY_SELECTED_IMAGES, getSelectedImages());
