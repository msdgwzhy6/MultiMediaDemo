package com.hyty.cordova.imagepicker.adapter;
...
import com.hyty.cordova.imagepicker.ui.ImageBaseActivity;
import com.hyty.cordova.imagepicker.ui.ImageGridActivity;
import com.hyty.cordova.imagepicker.util.Utils;
import com.hyty.cordova.imagepicker.view.SuperCheckBox;
...
public class ImageRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    private boolean isShowDelete;//是否需要显示checkbox
    ...
    public ImageRecyclerAdapter(Activity activity, ArrayList<ImageItem> images) {
        ...
        isShowDelete = MultiMediaConfig.getInstance().isCanDelete();
    }
    ...
    private class ImageViewHolder extends ViewHolder {
        ...
        ImageViewHolder(View itemView) {
            ...
            if (MultiMediaConfig.getInstance().getDoType() == 3 && !isShowDelete) {
        ...
        void bind(final int position) {
            ...
            //&&( MultiMediaConfig.getInstance().getDoType() == 3 && isShowDelete)
            ...
            mItemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!((ImageBaseActivity) mActivity).checkPermission(Manifest.permission.CAMERA)) {
                        ...
                        imagePicker.takePicture(mActivity, MultiMediaConfig.REQUEST_CODE_IMAGEPICKER_TAKECAMERA);
                    }
                }
            });
        }
