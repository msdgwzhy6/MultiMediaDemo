...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.jess.arms.http.imageloader.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.jess.arms.http.imageloader.glide.GlideOptions().apply(toSet));
    }
  }
}
