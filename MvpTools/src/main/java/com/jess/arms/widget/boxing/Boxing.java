 ...
 */
public class Boxing {
    public static final String EXTRA_SELECTED_MEDIA = "com.jess.arms.widget.boxing.Boxing.selected_media";
    public static final String EXTRA_ALBUM_ID = "com.jess.arms.widget.boxing.Boxing.album_id";

    static final String EXTRA_CONFIG = "com.jess.arms.widget.boxing.Boxing.config";
    static final String EXTRA_RESULT = "com.jess.arms.widget.boxing.Boxing.result";
    static final String EXTRA_START_POS = "com.jess.arms.widget.boxing.Boxing.start_pos";
    ...
    public interface OnBoxingFinishListener {
        ...
        /**
         * live with {@link com.jess.arms.widget.boxing.presenter.PickerContract.View#onFinish(List)}
         *
