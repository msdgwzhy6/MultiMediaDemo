...
package com.jess.arms.widget.boxing.impl.view;
...
import com.jess.arms.widget.boxing.model.entity.impl.VideoMedia;
...
public class MediaItemLayout extends FrameLayout {
    ...
    private void setCover(@NonNull String path) {
        ...
        mCoverImg.setTag(R.string.app_name, path);// TODO: 2017/6/2 修改App名称
